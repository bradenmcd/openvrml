...
public class MFVec3d extends MField {
     ...
     */
    public native void set1Value(int index, ConstSFVec3d vec);
     ...
     * @param vec New value for element.
     */
    public native void set1Value(int index, SFVec3d vec);
     ...
     */
    public native void addValue(ConstSFVec3d vec);
     ...
     * @param vec Element to add.
     */
    public native void addValue(SFVec3d vec);
     ...
     */
    public native void insertValue(int index, ConstSFVec3d vec);
     ...
     * @param vec Value to insert.
     */
    public native void insertValue(int index, SFVec3d vec);
