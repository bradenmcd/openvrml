...
*/
/**
 * Included with PhpWiki, which uses for now only the mysql-specific backend, 
 * instead of going through this main adodb.inc.php library.
 * Initial port by Lawrence Akka. See lib/WikiDB/ADODB.php
 */

if (!defined('_ADODB_LAYER')) {
 	define('_ADODB_LAYER',1);
rcs_id('$Id: adodb.inc.php,v 1.1.1.1 2004-04-13 23:41:40 braden Exp $');
