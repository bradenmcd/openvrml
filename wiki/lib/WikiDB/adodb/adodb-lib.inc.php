...
V1.71 18 Jan 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved.
  ...
  Less commonly used libraries here to reduce size of adodb.inc.php. 
  So we put less commonly used functions here!
*/ 
...
// Requires $ADODB_FETCH_MODE = ADODB_FETCH_ASSOC
