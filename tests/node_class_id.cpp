...
{
    node_class_id id("urn:foo:bar");
}

void construct_from_url()
{
    node_class_id id("http://example.com");
}
...
{
    BOOST_CHECK_THROW(node_class_id id("string"), std::invalid_argument);
}

boost::unit_test::test_suite * init_unit_test_suite(int, char * [])
{
    using boost::unit_test::test_suite;
    test_suite * const suite = BOOST_TEST_SUITE("node_class_id");
