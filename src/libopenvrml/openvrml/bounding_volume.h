...
namespace openvrml {
    ...
    class OPENVRML_SCOPE bounding_volume {
    public:
        enum intersection {
            inside = 1,
            outside = -1,
    ...
    class OPENVRML_SCOPE bounding_sphere : public bounding_volume {
        vec3f center_;
        float radius_;
    ...
    class OPENVRML_SCOPE axis_aligned_bounding_box : public bounding_volume {
    public:
