 ...
 * or reset with a NodeClass created with @c new (or 0).
 *
 ...
 */
NodeClassPtr::NodeClassPtr(NodeClass * const nodeClass): nodeClass(nodeClass) {
    try {
 ...
 * @param nodeClass a pointer to a NodeClass constructed with @c new.
 */
void NodeClassPtr::reset(NodeClass * const nodeClass) {
