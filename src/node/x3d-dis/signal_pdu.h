...
# ifndef OPENVRML_NODE_X3D_DIS_SIGNAL_PDU_H
#   define OPENVRML_NODE_X3D_DIS_SIGNAL_PDU_H
...
namespace openvrml_node_x3d_dis {
     ...
     */
    class OPENVRML_LOCAL signal_pdu_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_X3D_DIS_SIGNAL_PDU_H
