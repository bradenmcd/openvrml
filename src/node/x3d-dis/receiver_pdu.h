...
# ifndef OPENVRML_NODE_X3D_DIS_RECEIVER_PDU_H
#   define OPENVRML_NODE_X3D_DIS_RECEIVER_PDU_H
...
namespace openvrml_node_x3d_dis {
     ...
     */
    class OPENVRML_LOCAL receiver_pdu_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_DIS_RECEIVER_PDU_H
