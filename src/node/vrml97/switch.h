...
# ifndef OPENVRML_NODE_VRML97_SWITCH_H
#   define OPENVRML_NODE_VRML97_SWITCH_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL switch_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_SWITCH_H
