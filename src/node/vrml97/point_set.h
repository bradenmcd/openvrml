...
# ifndef OPENVRML_NODE_VRML97_POINT_SET_H
#   define OPENVRML_NODE_VRML97_POINT_SET_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL point_set_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_POINT_SET_H
