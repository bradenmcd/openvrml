...
# ifndef OPENVRML_NODE_VRML97_PIXEL_TEXTURE_H
#   define OPENVRML_NODE_VRML97_PIXEL_TEXTURE_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL pixel_texture_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_PIXEL_TEXTURE_H
