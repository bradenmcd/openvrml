...
# ifndef OPENVRML_NODE_VRML97_AUDIO_CLIP_H
#   define OPENVRML_NODE_VRML97_AUDIO_CLIP_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL audio_clip_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_AUDIO_CLIP_H
