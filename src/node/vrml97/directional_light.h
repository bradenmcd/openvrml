...
# ifndef OPENVRML_NODE_VRML97_DIRECTIONAL_LIGHT_H
#   define OPENVRML_NODE_VRML97_DIRECTIONAL_LIGHT_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL directional_light_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_DIRECTIONAL_LIGHT_H
