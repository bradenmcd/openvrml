...
# ifndef OPENVRML_NODE_VRML97_SCALAR_INTERPOLATOR_H
#   define OPENVRML_NODE_VRML97_SCALAR_INTERPOLATOR_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL scalar_interpolator_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_SCALAR_INTERPOLATOR_H
