...
# ifndef OPENVRML_NODE_VRML97_LOD_H
#   define OPENVRML_NODE_VRML97_LOD_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class lod_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_LOD_H
