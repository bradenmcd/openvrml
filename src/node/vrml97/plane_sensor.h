...
# ifndef OPENVRML_NODE_VRML97_PLANE_SENSOR_H
#   define OPENVRML_NODE_VRML97_PLANE_SENSOR_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL plane_sensor_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_PLANE_SENSOR_H
