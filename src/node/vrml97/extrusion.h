...
# ifndef OPENVRML_NODE_VRML97_EXTRUSION_H
#   define OPENVRML_NODE_VRML97_EXTRUSION_H
...
namespace openvrml_node_vrml97 {
     ...
     */
    class OPENVRML_LOCAL extrusion_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_VRML97_EXTRUSION_H
