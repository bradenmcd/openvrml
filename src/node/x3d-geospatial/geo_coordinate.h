...
# ifndef OPENVRML_NODE_X3D_GEOSPATIAL_GEO_COORDINATE_H
#   define OPENVRML_NODE_X3D_GEOSPATIAL_GEO_COORDINATE_H
...
namespace openvrml_node_x3d_geospatial {
     ...
     */
    class OPENVRML_LOCAL geo_coordinate_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_GEOSPATIAL_GEO_COORDINATE_H
