...
# ifndef OPENVRML_NODE_X3D_GEOSPATIAL_GEO_ORIGIN_H
#   define OPENVRML_NODE_X3D_GEOSPATIAL_GEO_ORIGIN_H
...
namespace openvrml_node_x3d_geospatial {
     ...
     */
    class OPENVRML_LOCAL geo_origin_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_X3D_GEOSPATIAL_GEO_ORIGIN_H
