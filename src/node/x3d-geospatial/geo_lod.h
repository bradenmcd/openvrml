...
# ifndef OPENVRML_NODE_X3D_GEOSPATIAL_GEO_LOD_H
#   define OPENVRML_NODE_X3D_GEOSPATIAL_GEO_LOD_H
...
namespace openvrml_node_x3d_geospatial {
     ...
     */
    class OPENVRML_LOCAL geo_lod_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_X3D_GEOSPATIAL_GEO_LOD_H
