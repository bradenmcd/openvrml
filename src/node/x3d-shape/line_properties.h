...
# ifndef OPENVRML_NODE_X3D_SHAPE_LINE_PROPERTIES_H
#   define OPENVRML_NODE_X3D_SHAPE_LINE_PROPERTIES_H
...
namespace openvrml_node_x3d_shape {
     ...
     */
    class OPENVRML_LOCAL line_properties_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_SHAPE_LINE_PROPERTIES_H
