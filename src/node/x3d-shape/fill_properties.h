...
# ifndef OPENVRML_NODE_X3D_SHAPE_FILL_PROPERTIES_H
#   define OPENVRML_NODE_X3D_SHAPE_FILL_PROPERTIES_H

#   include <openvrml/node.h>

namespace openvrml_node_x3d_shape {

    /**
     * @brief Class object for FillProperties nodes.
     */
    class OPENVRML_LOCAL fill_properties_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_SHAPE_FILL_PROPERTIES_H
