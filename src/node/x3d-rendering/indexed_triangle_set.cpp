...
namespace {
    ...
    class OPENVRML_LOCAL indexed_triangle_set_node :
        ...
        friend class openvrml_node_x3d_rendering::indexed_triangle_set_metatype;
 ...
 */
const char * const
openvrml_node_x3d_rendering::indexed_triangle_set_metatype::id =
 ...
 */
openvrml_node_x3d_rendering::indexed_triangle_set_metatype::
...
# define INDEXED_TRIANGLE_SET_INTERFACE_SEQ                             \
...
OPENVRML_NODE_IMPL_UTIL_DEFINE_DO_CREATE_TYPE(
    ...
    indexed_triangle_set_metatype,
    indexed_triangle_set_node,
    INDEXED_TRIANGLE_SET_INTERFACE_SEQ)
