...
# ifndef OPENVRML_NODE_X3D_RENDERING_TRIANGLE_FAN_SET_H
#   define OPENVRML_NODE_X3D_RENDERING_TRIANGLE_FAN_SET_H
...
namespace openvrml_node_x3d_rendering {
     ...
     */
    class OPENVRML_LOCAL triangle_fan_set_metatype :
...
# endif // OPENVRML_NODE_X3D_RENDERING_TRIANGLE_FAN_SET_H
