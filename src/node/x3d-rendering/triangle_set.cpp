...
namespace {
    ...
    class OPENVRML_LOCAL triangle_set_node :
        ...
        friend class openvrml_node_x3d_rendering::triangle_set_metatype;
 ...
 */
const char * const openvrml_node_x3d_rendering::triangle_set_metatype::id =
 ...
 */
openvrml_node_x3d_rendering::triangle_set_metatype::
triangle_set_metatype(openvrml::browser & browser):
 ...
 * @brief Destroy.
 */
openvrml_node_x3d_rendering::triangle_set_metatype::~triangle_set_metatype()
    OPENVRML_NOTHROW
{}

# define TRIANGLE_SET_INTERFACE_SEQ                                  \
