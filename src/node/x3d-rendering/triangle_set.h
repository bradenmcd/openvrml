...
# ifndef OPENVRML_NODE_X3D_RENDERING_TRIANGLE_SET_H
#   define OPENVRML_NODE_X3D_RENDERING_TRIANGLE_SET_H
...
namespace openvrml_node_x3d_rendering {
     ...
     */
    class OPENVRML_LOCAL triangle_set_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_RENDERING_TRIANGLE_SET_H
