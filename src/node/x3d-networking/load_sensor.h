...
#   define OPENVRML_NODE_X3D_NETWORKING_LOAD_SENSOR_H

#   include <openvrml/node.h>

namespace openvrml_node_x3d_networking {

    /**
     * @brief Class object for LoadSensor nodes.
     */
    class OPENVRML_LOCAL load_sensor_metatype : public openvrml::node_metatype {
    public:
...
# endif // ifndef OPENVRML_NODE_X3D_NETWORKING_LOAD_SENSOR_H
