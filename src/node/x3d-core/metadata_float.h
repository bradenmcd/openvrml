...
# ifndef OPENVRML_NODE_X3D_CORE_METADATA_FLOAT_H
#   define OPENVRML_NODE_X3D_CORE_METADATA_FLOAT_H
...
namespace openvrml_node_x3d_core {
     ...
     */
    class OPENVRML_LOCAL metadata_float_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_CORE_METADATA_FLOAT_H
