...
# ifndef OPENVRML_NODE_X3D_CORE_METADATA_DOUBLE_H
#   define OPENVRML_NODE_X3D_CORE_METADATA_DOUBLE_H
...
namespace openvrml_node_x3d_core {
     ...
     */
    class OPENVRML_LOCAL metadata_double_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_CORE_METADATA_DOUBLE_H
