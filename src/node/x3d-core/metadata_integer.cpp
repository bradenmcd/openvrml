...
namespace {
    ...
    class OPENVRML_LOCAL metadata_integer_node :
        ...
        friend class openvrml_node_x3d_core::metadata_integer_metatype;
 ...
 */
const char * const openvrml_node_x3d_core::metadata_integer_metatype::id =
 ...
 */
openvrml_node_x3d_core::metadata_integer_metatype::
 ...
 * @brief Destroy.
 */
openvrml_node_x3d_core::metadata_integer_metatype::~metadata_integer_metatype()
    OPENVRML_NOTHROW
{}

# define METADATA_INTEGER_INTERFACE_SEQ                 \
    ((exposedfield, sfnode,   "metadata",  metadata))   \
    ((exposedfield, sfstring, "name",      name_))      \
    ((exposedfield, sfstring, "reference", reference_)) \
    ((exposedfield, mfint32,  "value",     value_))

OPENVRML_NODE_IMPL_UTIL_DEFINE_DO_CREATE_TYPE(openvrml_node_x3d_core,
                                              metadata_integer_metatype,
                                              metadata_integer_node,
                                              METADATA_INTEGER_INTERFACE_SEQ)
