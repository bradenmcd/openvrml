...
# ifndef OPENVRML_NODE_X3D_CORE_METADATA_SET_H
#   define OPENVRML_NODE_X3D_CORE_METADATA_SET_H
...
namespace openvrml_node_x3d_core {
     ...
     */
    class OPENVRML_LOCAL metadata_set_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_CORE_METADATA_SET_H
