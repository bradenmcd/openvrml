...
# ifndef OPENVRML_NODE_X3D_EVENT_UTILITIES_BOOLEAN_TRIGGER_H
#   define OPENVRML_NODE_X3D_EVENT_UTILITIES_BOOLEAN_TRIGGER_H
...
namespace openvrml_node_x3d_event_utilities {
     ...
     */
    class OPENVRML_LOCAL boolean_trigger_metatype :
...
# endif // ifndef OPENVRML_NODE_X3D_EVENT_UTILITIES_BOOLEAN_TRIGGER_H
